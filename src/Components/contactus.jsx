...
<div className="container asjvdasyu">
        <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 map-col">
        ...
        position="relative"/>
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 form-col">
                <h4  className='text-4xl   mt-10'>Have Any Queries?</h4>
               
                    <div className="row">
                      <div className="col">
                        <input type="text" className="form-control my-8" placeholder="Your Name"/>
                      </div>
                      <div className="col">
                        <input type="email" className="form-control  my-8" id="inputEmail4" placeholder="Email Address"/>
                      </div>
                    </div>
                    <div className="row">
                        <div className="col">
                          <input type="tel" className="form-control  mb-8" placeholder="Phone Number"/>
                        </div>
                        <div className="col">
                          <input type="email" className="form-control mb-8" id="inputEmail4" placeholder="Subjects"/>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col">
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="6" placeholder="Write a Message"></textarea>
                            <button type="submit" className="submit-btn button  bg-white  text-black">SUBMIT</button>
                        </div>
        ...
        <div className="footer-content">
          ...
          <div className="footer-content-column">
            <div className="footer-call-to-action">
              ...
              <button className='nnju kkllo border-black text-xl text-black mt-6 px-11 py-4 '>SUBSCRIBE</button>
              </div>
            </div>
            <div className="footer-call-to-action">
